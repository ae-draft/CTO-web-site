...
--
-- Host: localhost
-- Generation Time: Dec 05, 2012 at 06:28 PM
...
--
-- Table structure for table `mqaxv_assets`
--

CREATE TABLE IF NOT EXISTS `mqaxv_assets` (
...
--
-- Dumping data for table `mqaxv_assets`
--

INSERT INTO `mqaxv_assets` (`id`, `parent_id`, `lft`, `rgt`, `level`, `name`, `title`, `rules`) VALUES
...
--
-- Table structure for table `mqaxv_associations`
--

CREATE TABLE IF NOT EXISTS `mqaxv_associations` (
...
--
-- Dumping data for table `mqaxv_associations`
--
...
--
-- Table structure for table `mqaxv_banners`
--

CREATE TABLE IF NOT EXISTS `mqaxv_banners` (
...
--
-- Dumping data for table `mqaxv_banners`
--
...
--
-- Table structure for table `mqaxv_banner_clients`
--

CREATE TABLE IF NOT EXISTS `mqaxv_banner_clients` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) NOT NULL DEFAULT '',
...
--
-- Dumping data for table `mqaxv_banner_clients`
--
...
--
-- Table structure for table `mqaxv_banner_tracks`
--

CREATE TABLE IF NOT EXISTS `mqaxv_banner_tracks` (
...
--
-- Dumping data for table `mqaxv_banner_tracks`
--
...
--
-- Table structure for table `mqaxv_categories`
--

CREATE TABLE IF NOT EXISTS `mqaxv_categories` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `mqaxv_categories`
--

INSERT INTO `mqaxv_categories` (`id`, `asset_id`, `parent_id`, `lft`, `rgt`, `level`, `path`, `extension`, `title`, `alias`, `note`, `description`, `published`, `checked_out`, `checked_out_time`, `access`, `params`, `metadesc`, `metakey`, `metadata`, `created_user_id`, `created_time`, `modified_user_id`, `modified_time`, `hits`, `language`) VALUES
...
--
-- Table structure for table `mqaxv_contact_details`
--

CREATE TABLE IF NOT EXISTS `mqaxv_contact_details` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) NOT NULL DEFAULT '',
  `alias` varchar(255) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL DEFAULT '',
...
--
-- Dumping data for table `mqaxv_contact_details`
--
...
--
-- Table structure for table `mqaxv_content`
--

CREATE TABLE IF NOT EXISTS `mqaxv_content` (
...
--
-- Dumping data for table `mqaxv_content`
--
...
--
-- Table structure for table `mqaxv_content_frontpage`
--

CREATE TABLE IF NOT EXISTS `mqaxv_content_frontpage` (
...
--
-- Dumping data for table `mqaxv_content_frontpage`
--
...
--
-- Table structure for table `mqaxv_content_rating`
--

CREATE TABLE IF NOT EXISTS `mqaxv_content_rating` (
  `content_id` int(11) NOT NULL DEFAULT '0',
...
--
-- Dumping data for table `mqaxv_content_rating`
--
...
--
-- Table structure for table `mqaxv_core_log_searches`
--

CREATE TABLE IF NOT EXISTS `mqaxv_core_log_searches` (
  `search_term` varchar(128) NOT NULL DEFAULT '',
  `hits` int(10) unsigned NOT NULL DEFAULT '0'
) ENGINE=MyISAM DEFAULT CHARSET=utf8;

--
-- Dumping data for table `mqaxv_core_log_searches`
--
...
--
-- Table structure for table `mqaxv_extensions`
--

CREATE TABLE IF NOT EXISTS `mqaxv_extensions` (
...
--
-- Dumping data for table `mqaxv_extensions`
--

INSERT INTO `mqaxv_extensions` (`extension_id`, `name`, `type`, `element`, `folder`, `client_id`, `enabled`, `access`, `protected`, `manifest_cache`, `params`, `custom_data`, `system_data`, `checked_out`, `checked_out_time`, `ordering`, `state`) VALUES
...
--
-- Table structure for table `mqaxv_finder_filters`
--

CREATE TABLE IF NOT EXISTS `mqaxv_finder_filters` (
...
--
-- Dumping data for table `mqaxv_finder_filters`
--
...
--
-- Table structure for table `mqaxv_finder_links`
--

CREATE TABLE IF NOT EXISTS `mqaxv_finder_links` (
...
--
-- Dumping data for table `mqaxv_finder_links`
--
...
--
-- Table structure for table `mqaxv_finder_links_terms0`
--

CREATE TABLE IF NOT EXISTS `mqaxv_finder_links_terms0` (
...
--
-- Dumping data for table `mqaxv_finder_links_terms0`
--
...
--
-- Table structure for table `mqaxv_finder_links_terms1`
--

CREATE TABLE IF NOT EXISTS `mqaxv_finder_links_terms1` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Dumping data for table `mqaxv_finder_links_terms1`
--
...
--
-- Table structure for table `mqaxv_finder_links_terms2`
--

CREATE TABLE IF NOT EXISTS `mqaxv_finder_links_terms2` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Dumping data for table `mqaxv_finder_links_terms2`
--
...
--
-- Table structure for table `mqaxv_finder_links_terms3`
--

CREATE TABLE IF NOT EXISTS `mqaxv_finder_links_terms3` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Dumping data for table `mqaxv_finder_links_terms3`
--
...
--
-- Table structure for table `mqaxv_finder_links_terms4`
--

CREATE TABLE IF NOT EXISTS `mqaxv_finder_links_terms4` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Dumping data for table `mqaxv_finder_links_terms4`
--
...
--
-- Table structure for table `mqaxv_finder_links_terms5`
--

CREATE TABLE IF NOT EXISTS `mqaxv_finder_links_terms5` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Dumping data for table `mqaxv_finder_links_terms5`
--
...
--
-- Table structure for table `mqaxv_finder_links_terms6`
--

CREATE TABLE IF NOT EXISTS `mqaxv_finder_links_terms6` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Dumping data for table `mqaxv_finder_links_terms6`
--
...
--
-- Table structure for table `mqaxv_finder_links_terms7`
--

CREATE TABLE IF NOT EXISTS `mqaxv_finder_links_terms7` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Dumping data for table `mqaxv_finder_links_terms7`
--
...
--
-- Table structure for table `mqaxv_finder_links_terms8`
--

CREATE TABLE IF NOT EXISTS `mqaxv_finder_links_terms8` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Dumping data for table `mqaxv_finder_links_terms8`
--
...
--
-- Table structure for table `mqaxv_finder_links_terms9`
--

CREATE TABLE IF NOT EXISTS `mqaxv_finder_links_terms9` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Dumping data for table `mqaxv_finder_links_terms9`
--
...
--
-- Table structure for table `mqaxv_finder_links_termsa`
--

CREATE TABLE IF NOT EXISTS `mqaxv_finder_links_termsa` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Dumping data for table `mqaxv_finder_links_termsa`
--
...
--
-- Table structure for table `mqaxv_finder_links_termsb`
--

CREATE TABLE IF NOT EXISTS `mqaxv_finder_links_termsb` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Dumping data for table `mqaxv_finder_links_termsb`
--
...
--
-- Table structure for table `mqaxv_finder_links_termsc`
--

CREATE TABLE IF NOT EXISTS `mqaxv_finder_links_termsc` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Dumping data for table `mqaxv_finder_links_termsc`
--
...
--
-- Table structure for table `mqaxv_finder_links_termsd`
--

CREATE TABLE IF NOT EXISTS `mqaxv_finder_links_termsd` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Dumping data for table `mqaxv_finder_links_termsd`
--
...
--
-- Table structure for table `mqaxv_finder_links_termse`
--

CREATE TABLE IF NOT EXISTS `mqaxv_finder_links_termse` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Dumping data for table `mqaxv_finder_links_termse`
--
...
--
-- Table structure for table `mqaxv_finder_links_termsf`
--

CREATE TABLE IF NOT EXISTS `mqaxv_finder_links_termsf` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Dumping data for table `mqaxv_finder_links_termsf`
--
...
--
-- Table structure for table `mqaxv_finder_taxonomy`
--

CREATE TABLE IF NOT EXISTS `mqaxv_finder_taxonomy` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `parent_id` int(10) unsigned NOT NULL DEFAULT '0',
  `title` varchar(255) NOT NULL,
...
--
-- Dumping data for table `mqaxv_finder_taxonomy`
--

INSERT INTO `mqaxv_finder_taxonomy` (`id`, `parent_id`, `title`, `state`, `access`, `ordering`) VALUES
(1, 0, 'ROOT', 0, 0, 0);

-- --------------------------------------------------------

--
-- Table structure for table `mqaxv_finder_taxonomy_map`
--

CREATE TABLE IF NOT EXISTS `mqaxv_finder_taxonomy_map` (
  `link_id` int(10) unsigned NOT NULL,
...
--
-- Dumping data for table `mqaxv_finder_taxonomy_map`
--
...
--
-- Table structure for table `mqaxv_finder_terms`
--

CREATE TABLE IF NOT EXISTS `mqaxv_finder_terms` (
...
--
-- Dumping data for table `mqaxv_finder_terms`
--
...
--
-- Table structure for table `mqaxv_finder_terms_common`
--

CREATE TABLE IF NOT EXISTS `mqaxv_finder_terms_common` (
  `term` varchar(75) NOT NULL,
...
--
-- Dumping data for table `mqaxv_finder_terms_common`
--

INSERT INTO `mqaxv_finder_terms_common` (`term`, `language`) VALUES
('a', 'en'),
('about', 'en'),
('after', 'en'),
('ago', 'en'),
...
--
-- Table structure for table `mqaxv_finder_tokens`
--

CREATE TABLE IF NOT EXISTS `mqaxv_finder_tokens` (
  `term` varchar(75) NOT NULL,
  `stem` varchar(75) NOT NULL,
  `common` tinyint(1) unsigned NOT NULL DEFAULT '0',
  `phrase` tinyint(1) unsigned NOT NULL DEFAULT '0',
...
--
-- Dumping data for table `mqaxv_finder_tokens`
--
...
--
-- Table structure for table `mqaxv_finder_tokens_aggregate`
--

CREATE TABLE IF NOT EXISTS `mqaxv_finder_tokens_aggregate` (
  `term_id` int(10) unsigned NOT NULL,
...
--
-- Dumping data for table `mqaxv_finder_tokens_aggregate`
--
...
--
-- Table structure for table `mqaxv_finder_types`
--

CREATE TABLE IF NOT EXISTS `mqaxv_finder_types` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `mqaxv_finder_types`
--
...
--
-- Table structure for table `mqaxv_languages`
--

CREATE TABLE IF NOT EXISTS `mqaxv_languages` (
...
--
-- Dumping data for table `mqaxv_languages`
--

INSERT INTO `mqaxv_languages` (`lang_id`, `lang_code`, `title`, `title_native`, `sef`, `image`, `description`, `metakey`, `metadesc`, `sitename`, `published`, `access`, `ordering`) VALUES
...
--
-- Table structure for table `mqaxv_menu`
--

CREATE TABLE IF NOT EXISTS `mqaxv_menu` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `mqaxv_menu`
--

INSERT INTO `mqaxv_menu` (`id`, `menutype`, `title`, `alias`, `note`, `path`, `link`, `type`, `published`, `parent_id`, `level`, `component_id`, `ordering`, `checked_out`, `checked_out_time`, `browserNav`, `access`, `img`, `template_style_id`, `params`, `lft`, `rgt`, `home`, `language`, `client_id`) VALUES
...
--
-- Table structure for table `mqaxv_menu_types`
--

CREATE TABLE IF NOT EXISTS `mqaxv_menu_types` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `mqaxv_menu_types`
--

INSERT INTO `mqaxv_menu_types` (`id`, `menutype`, `title`, `description`) VALUES
(1, 'mainmenu', 'Главное меню', 'The main menu for the site');

-- --------------------------------------------------------

--
-- Table structure for table `mqaxv_messages`
--

CREATE TABLE IF NOT EXISTS `mqaxv_messages` (
...
--
-- Dumping data for table `mqaxv_messages`
--
...
--
-- Table structure for table `mqaxv_messages_cfg`
--

CREATE TABLE IF NOT EXISTS `mqaxv_messages_cfg` (
...
--
-- Dumping data for table `mqaxv_messages_cfg`
--
...
--
-- Table structure for table `mqaxv_modules`
--

CREATE TABLE IF NOT EXISTS `mqaxv_modules` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `mqaxv_modules`
--

INSERT INTO `mqaxv_modules` (`id`, `title`, `note`, `content`, `ordering`, `position`, `checked_out`, `checked_out_time`, `publish_up`, `publish_down`, `published`, `module`, `access`, `showtitle`, `params`, `client_id`, `language`) VALUES
...
--
-- Table structure for table `mqaxv_modules_menu`
--

CREATE TABLE IF NOT EXISTS `mqaxv_modules_menu` (
...
--
-- Dumping data for table `mqaxv_modules_menu`
--

INSERT INTO `mqaxv_modules_menu` (`moduleid`, `menuid`) VALUES
(1, 0),
(2, 0),
(3, 0),
(4, 0),
...
--
-- Table structure for table `mqaxv_newsfeeds`
--

CREATE TABLE IF NOT EXISTS `mqaxv_newsfeeds` (
  `catid` int(11) NOT NULL DEFAULT '0',
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `mqaxv_newsfeeds`
--
...
--
-- Table structure for table `mqaxv_overrider`
--

CREATE TABLE IF NOT EXISTS `mqaxv_overrider` (
...
--
-- Dumping data for table `mqaxv_overrider`
--
...
--
-- Table structure for table `mqaxv_redirect_links`
--

CREATE TABLE IF NOT EXISTS `mqaxv_redirect_links` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `mqaxv_redirect_links`
--
...
--
-- Table structure for table `mqaxv_schemas`
--

CREATE TABLE IF NOT EXISTS `mqaxv_schemas` (
...
--
-- Dumping data for table `mqaxv_schemas`
--

INSERT INTO `mqaxv_schemas` (`extension_id`, `version_id`) VALUES
(700, '2.5.6');

-- --------------------------------------------------------

--
-- Table structure for table `mqaxv_session`
--

CREATE TABLE IF NOT EXISTS `mqaxv_session` (
...
--
-- Dumping data for table `mqaxv_session`
--

INSERT INTO `mqaxv_session` (`session_id`, `client_id`, `guest`, `time`, `data`, `userid`, `username`, `usertype`) VALUES
('4393e2342f86f6158db7591ecd47e539', 0, 1, '1354710635', '__default|a:7:{s:22:"session.client.browser";s:101:"Mozilla/5.0 (Windows NT 6.1) AppleWebKit/537.11 (KHTML, like Gecko) Chrome/23.0.1271.95 Safari/537.11";s:15:"session.counter";i:2;s:8:"registry";O:9:"JRegistry":1:{s:7:"\0*\0data";O:8:"stdClass":0:{}}s:4:"user";O:5:"JUser":25:{s:9:"\0*\0isRoot";b:0;s:2:"id";i:0;s:4:"name";N;s:8:"username";N;s:5:"email";N;s:8:"password";N;s:14:"password_clear";s:0:"";s:8:"usertype";N;s:5:"block";N;s:9:"sendEmail";i:0;s:12:"registerDate";N;s:13:"lastvisitDate";N;s:10:"activation";N;s:6:"params";N;s:6:"groups";a:0:{}s:5:"guest";i:1;s:13:"lastResetTime";N;s:10:"resetCount";N;s:10:"\0*\0_params";O:9:"JRegistry":1:{s:7:"\0*\0data";O:8:"stdClass":0:{}}s:14:"\0*\0_authGroups";a:1:{i:0;i:1;}s:14:"\0*\0_authLevels";a:2:{i:0;i:1;i:1;i:1;}s:15:"\0*\0_authActions";N;s:12:"\0*\0_errorMsg";N;s:10:"\0*\0_errors";a:0:{}s:3:"aid";i:0;}s:19:"session.timer.start";i:1354710635;s:18:"session.timer.last";i:1354710635;s:17:"session.timer.now";i:1354710635;}', 0, '', '');

-- --------------------------------------------------------

--
-- Table structure for table `mqaxv_template_styles`
--

CREATE TABLE IF NOT EXISTS `mqaxv_template_styles` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `mqaxv_template_styles`
--

INSERT INTO `mqaxv_template_styles` (`id`, `template`, `client_id`, `home`, `title`, `params`) VALUES
...
(7, 'cto', 0, '1', 'CTO_template - По умолчанию', '{}');

-- --------------------------------------------------------

--
-- Table structure for table `mqaxv_updates`
--

CREATE TABLE IF NOT EXISTS `mqaxv_updates` (
...
--
-- Dumping data for table `mqaxv_updates`
--
...
--
-- Table structure for table `mqaxv_update_categories`
--

CREATE TABLE IF NOT EXISTS `mqaxv_update_categories` (
...
--
-- Dumping data for table `mqaxv_update_categories`
--
...
--
-- Table structure for table `mqaxv_update_sites`
--

CREATE TABLE IF NOT EXISTS `mqaxv_update_sites` (
...
--
-- Dumping data for table `mqaxv_update_sites`
--

INSERT INTO `mqaxv_update_sites` (`update_site_id`, `name`, `type`, `location`, `enabled`, `last_check_timestamp`) VALUES
(1, 'Joomla Core', 'collection', 'http://update.joomla.org/core/list.xml', 0, 1354707782),
(2, 'Joomla Extension Directory', 'collection', 'http://update.joomla.org/jed/list.xml', 0, 1354707782);

-- --------------------------------------------------------

--
-- Table structure for table `mqaxv_update_sites_extensions`
--

CREATE TABLE IF NOT EXISTS `mqaxv_update_sites_extensions` (
...
--
-- Dumping data for table `mqaxv_update_sites_extensions`
--

INSERT INTO `mqaxv_update_sites_extensions` (`update_site_id`, `extension_id`) VALUES
(1, 700),
(2, 700);
...
--
-- Table structure for table `mqaxv_usergroups`
--

CREATE TABLE IF NOT EXISTS `mqaxv_usergroups` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Primary Key',
...
--
-- Dumping data for table `mqaxv_usergroups`
--

INSERT INTO `mqaxv_usergroups` (`id`, `parent_id`, `lft`, `rgt`, `title`) VALUES
(1, 0, 1, 20, 'Все'),
...
--
-- Table structure for table `mqaxv_users`
--

CREATE TABLE IF NOT EXISTS `mqaxv_users` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) NOT NULL DEFAULT '',
...
--
-- Dumping data for table `mqaxv_users`
--

INSERT INTO `mqaxv_users` (`id`, `name`, `username`, `email`, `password`, `usertype`, `block`, `sendEmail`, `registerDate`, `lastvisitDate`, `activation`, `params`, `lastResetTime`, `resetCount`) VALUES
(87, 'Super User', 'admin', 'antiinformation@gmail.com', '911987f8ca6ca61cf3240ac90bcc6042:smBX4W6TU7ja8JdNYr9jV2bEyw0DN5hY', 'deprecated', 0, 1, '2012-12-05 09:14:20', '2012-12-05 11:42:58', '0', '', '0000-00-00 00:00:00', 0);

-- --------------------------------------------------------

--
-- Table structure for table `mqaxv_user_notes`
--

CREATE TABLE IF NOT EXISTS `mqaxv_user_notes` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `user_id` int(10) unsigned NOT NULL DEFAULT '0',
  `catid` int(10) unsigned NOT NULL DEFAULT '0',
...
--
-- Dumping data for table `mqaxv_user_notes`
--
...
--
-- Table structure for table `mqaxv_user_profiles`
--

CREATE TABLE IF NOT EXISTS `mqaxv_user_profiles` (
...
--
-- Dumping data for table `mqaxv_user_profiles`
--
...
--
-- Table structure for table `mqaxv_user_usergroup_map`
--

CREATE TABLE IF NOT EXISTS `mqaxv_user_usergroup_map` (
...
--
-- Dumping data for table `mqaxv_user_usergroup_map`
--

INSERT INTO `mqaxv_user_usergroup_map` (`user_id`, `group_id`) VALUES
(87, 8);

-- --------------------------------------------------------

--
-- Table structure for table `mqaxv_viewlevels`
--

CREATE TABLE IF NOT EXISTS `mqaxv_viewlevels` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Primary Key',
  `title` varchar(100) NOT NULL DEFAULT '',
  `ordering` int(11) NOT NULL DEFAULT '0',
  `rules` varchar(5120) NOT NULL COMMENT 'JSON encoded access control.',
...
--
-- Dumping data for table `mqaxv_viewlevels`
--

INSERT INTO `mqaxv_viewlevels` (`id`, `title`, `ordering`, `rules`) VALUES
(1, 'Для всех', 0, '[1]'),
...
--
-- Table structure for table `mqaxv_weblinks`
--

CREATE TABLE IF NOT EXISTS `mqaxv_weblinks` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `catid` int(11) NOT NULL DEFAULT '0',
...
--
-- Dumping data for table `mqaxv_weblinks`
--
...
--
-- Table structure for table `q61rg_assets`
--

CREATE TABLE IF NOT EXISTS `q61rg_assets` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Primary Key',
  `parent_id` int(11) NOT NULL DEFAULT '0' COMMENT 'Nested set parent.',
  `lft` int(11) NOT NULL DEFAULT '0' COMMENT 'Nested set lft.',
  `rgt` int(11) NOT NULL DEFAULT '0' COMMENT 'Nested set rgt.',
...
--
-- Table structure for table `q61rg_associations`
--

CREATE TABLE IF NOT EXISTS `q61rg_associations` (
  `id` varchar(50) NOT NULL COMMENT 'A reference to the associated item.',
  `context` varchar(50) NOT NULL COMMENT 'The context of the associated item.',
  `key` char(32) NOT NULL COMMENT 'The key for the association computed from an md5 on associated ids.',
  PRIMARY KEY (`context`,`id`),
...
--
-- Dumping data for table `q61rg_associations`
--
...
--
-- Table structure for table `q61rg_banners`
--

CREATE TABLE IF NOT EXISTS `q61rg_banners` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `cid` int(11) NOT NULL DEFAULT '0',
  `type` int(11) NOT NULL DEFAULT '0',
  `name` varchar(255) NOT NULL DEFAULT '',
...
--
-- Dumping data for table `q61rg_banners`
--
...
--
-- Table structure for table `q61rg_banner_clients`
--

CREATE TABLE IF NOT EXISTS `q61rg_banner_clients` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) NOT NULL DEFAULT '',
  `contact` varchar(255) NOT NULL DEFAULT '',
  `email` varchar(255) NOT NULL DEFAULT '',
...
--
-- Dumping data for table `q61rg_banner_clients`
--
...
--
-- Table structure for table `q61rg_banner_tracks`
--

CREATE TABLE IF NOT EXISTS `q61rg_banner_tracks` (
  `track_date` datetime NOT NULL,
  `track_type` int(10) unsigned NOT NULL,
  `banner_id` int(10) unsigned NOT NULL,
  `count` int(10) unsigned NOT NULL DEFAULT '0',
...
--
-- Dumping data for table `q61rg_banner_tracks`
--
...
--
-- Table structure for table `q61rg_categories`
--

CREATE TABLE IF NOT EXISTS `q61rg_categories` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `asset_id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT 'FK to the #__assets table.',
  `parent_id` int(10) unsigned NOT NULL DEFAULT '0',
  `lft` int(11) NOT NULL DEFAULT '0',
...
--
-- Table structure for table `q61rg_contact_details`
--

CREATE TABLE IF NOT EXISTS `q61rg_contact_details` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) NOT NULL DEFAULT '',
  `alias` varchar(255) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL DEFAULT '',
  `con_position` varchar(255) DEFAULT NULL,
...
--
-- Dumping data for table `q61rg_contact_details`
--
...
--
-- Table structure for table `q61rg_content`
--

CREATE TABLE IF NOT EXISTS `q61rg_content` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `asset_id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT 'FK to the #__assets table.',
  `title` varchar(255) NOT NULL DEFAULT '',
  `alias` varchar(255) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL DEFAULT '',
...
--
-- Table structure for table `q61rg_content_frontpage`
--

CREATE TABLE IF NOT EXISTS `q61rg_content_frontpage` (
  `content_id` int(11) NOT NULL DEFAULT '0',
  `ordering` int(11) NOT NULL DEFAULT '0',
  PRIMARY KEY (`content_id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
--
-- Dumping data for table `q61rg_content_frontpage`
--
...
--
-- Table structure for table `q61rg_content_rating`
--

CREATE TABLE IF NOT EXISTS `q61rg_content_rating` (
  `content_id` int(11) NOT NULL DEFAULT '0',
  `rating_sum` int(10) unsigned NOT NULL DEFAULT '0',
  `rating_count` int(10) unsigned NOT NULL DEFAULT '0',
  `lastip` varchar(50) NOT NULL DEFAULT '',
...
--
-- Dumping data for table `q61rg_content_rating`
--
...
--
-- Table structure for table `q61rg_core_log_searches`
--

CREATE TABLE IF NOT EXISTS `q61rg_core_log_searches` (
  `search_term` varchar(128) NOT NULL DEFAULT '',
  `hits` int(10) unsigned NOT NULL DEFAULT '0'
) ENGINE=MyISAM DEFAULT CHARSET=utf8;

--
-- Dumping data for table `q61rg_core_log_searches`
--
...
--
-- Table structure for table `q61rg_extensions`
--

CREATE TABLE IF NOT EXISTS `q61rg_extensions` (
  `extension_id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(100) NOT NULL,
  `type` varchar(20) NOT NULL,
  `element` varchar(100) NOT NULL,
...
INSERT INTO `q61rg_extensions` (`extension_id`, `name`, `type`, `element`, `folder`, `client_id`, `enabled`, `access`, `protected`, `manifest_cache`, `params`, `custom_data`, `system_data`, `checked_out`, `checked_out_time`, `ordering`, `state`) VALUES
(1, 'com_mailto', 'component', 'com_mailto', '', 0, 1, 1, 1, '{"legacy":false,"name":"com_mailto","type":"component","creationDate":"April 2006","author":"Joomla! Project","copyright":"(C) 2005 - 2012 Open Source Matters. All rights reserved.\\t","authorEmail":"admin@joomla.org","authorUrl":"www.joomla.org","version":"2.5.0","description":"COM_MAILTO_XML_DESCRIPTION","group":""}', '', '', '', 0, '0000-00-00 00:00:00', 0, 0),
(2, 'com_wrapper', 'component', 'com_wrapper', '', 0, 1, 1, 1, '{"legacy":false,"name":"com_wrapper","type":"component","creationDate":"April 2006","author":"Joomla! Project","copyright":"(C) 2005 - 2012 Open Source Matters. All rights reserved.\\n\\t","authorEmail":"admin@joomla.org","authorUrl":"www.joomla.org","version":"2.5.0","description":"COM_WRAPPER_XML_DESCRIPTION","group":""}', '', '', '', 0, '0000-00-00 00:00:00', 0, 0),
(3, 'com_admin', 'component', 'com_admin', '', 1, 1, 1, 1, '{"legacy":false,"name":"com_admin","type":"component","creationDate":"April 2006","author":"Joomla! Project","copyright":"(C) 2005 - 2012 Open Source Matters. All rights reserved.\\n\\t","authorEmail":"admin@joomla.org","authorUrl":"www.joomla.org","version":"2.5.0","description":"COM_ADMIN_XML_DESCRIPTION","group":""}', '', '', '', 0, '0000-00-00 00:00:00', 0, 0),
(4, 'com_banners', 'component', 'com_banners', '', 1, 1, 1, 0, '{"legacy":false,"name":"com_banners","type":"component","creationDate":"April 2006","author":"Joomla! Project","copyright":"(C) 2005 - 2012 Open Source Matters. All rights reserved.\\n\\t","authorEmail":"admin@joomla.org","authorUrl":"www.joomla.org","version":"2.5.0","description":"COM_BANNERS_XML_DESCRIPTION","group":""}', '{"purchase_type":"3","track_impressions":"0","track_clicks":"0","metakey_prefix":""}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
...
--
-- Table structure for table `q61rg_finder_filters`
--

CREATE TABLE IF NOT EXISTS `q61rg_finder_filters` (
  `filter_id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `title` varchar(255) NOT NULL,
  `alias` varchar(255) NOT NULL,
  `state` tinyint(1) NOT NULL DEFAULT '1',
...
--
-- Dumping data for table `q61rg_finder_filters`
--
...
--
-- Table structure for table `q61rg_finder_links`
--

CREATE TABLE IF NOT EXISTS `q61rg_finder_links` (
  `link_id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `url` varchar(255) NOT NULL,
  `route` varchar(255) NOT NULL,
  `title` varchar(255) DEFAULT NULL,
...
--
-- Dumping data for table `q61rg_finder_links`
--
...
--
-- Table structure for table `q61rg_finder_links_terms0`
--

CREATE TABLE IF NOT EXISTS `q61rg_finder_links_terms0` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Dumping data for table `q61rg_finder_links_terms0`
--
...
--
-- Table structure for table `q61rg_finder_links_terms1`
--

CREATE TABLE IF NOT EXISTS `q61rg_finder_links_terms1` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Dumping data for table `q61rg_finder_links_terms1`
--
...
--
-- Table structure for table `q61rg_finder_links_terms2`
--

CREATE TABLE IF NOT EXISTS `q61rg_finder_links_terms2` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Dumping data for table `q61rg_finder_links_terms2`
--
...
--
-- Table structure for table `q61rg_finder_links_terms3`
--

CREATE TABLE IF NOT EXISTS `q61rg_finder_links_terms3` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Dumping data for table `q61rg_finder_links_terms3`
--
...
--
-- Table structure for table `q61rg_finder_links_terms4`
--

CREATE TABLE IF NOT EXISTS `q61rg_finder_links_terms4` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Dumping data for table `q61rg_finder_links_terms4`
--
...
--
-- Table structure for table `q61rg_finder_links_terms5`
--

CREATE TABLE IF NOT EXISTS `q61rg_finder_links_terms5` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Dumping data for table `q61rg_finder_links_terms5`
--
...
--
-- Table structure for table `q61rg_finder_links_terms6`
--

CREATE TABLE IF NOT EXISTS `q61rg_finder_links_terms6` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Dumping data for table `q61rg_finder_links_terms6`
--
...
--
-- Table structure for table `q61rg_finder_links_terms7`
--

CREATE TABLE IF NOT EXISTS `q61rg_finder_links_terms7` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Dumping data for table `q61rg_finder_links_terms7`
--
...
--
-- Table structure for table `q61rg_finder_links_terms8`
--

CREATE TABLE IF NOT EXISTS `q61rg_finder_links_terms8` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Dumping data for table `q61rg_finder_links_terms8`
--
...
--
-- Table structure for table `q61rg_finder_links_terms9`
--

CREATE TABLE IF NOT EXISTS `q61rg_finder_links_terms9` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Dumping data for table `q61rg_finder_links_terms9`
--
...
--
-- Table structure for table `q61rg_finder_links_termsa`
--

CREATE TABLE IF NOT EXISTS `q61rg_finder_links_termsa` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Dumping data for table `q61rg_finder_links_termsa`
--
...
--
-- Table structure for table `q61rg_finder_links_termsb`
--

CREATE TABLE IF NOT EXISTS `q61rg_finder_links_termsb` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Dumping data for table `q61rg_finder_links_termsb`
--
...
--
-- Table structure for table `q61rg_finder_links_termsc`
--

CREATE TABLE IF NOT EXISTS `q61rg_finder_links_termsc` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Dumping data for table `q61rg_finder_links_termsc`
--
...
--
-- Table structure for table `q61rg_finder_links_termsd`
--

CREATE TABLE IF NOT EXISTS `q61rg_finder_links_termsd` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Dumping data for table `q61rg_finder_links_termsd`
--
...
--
-- Table structure for table `q61rg_finder_links_termse`
--

CREATE TABLE IF NOT EXISTS `q61rg_finder_links_termse` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Dumping data for table `q61rg_finder_links_termse`
--
...
--
-- Table structure for table `q61rg_finder_links_termsf`
--

CREATE TABLE IF NOT EXISTS `q61rg_finder_links_termsf` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Dumping data for table `q61rg_finder_links_termsf`
--
...
--
-- Table structure for table `q61rg_finder_taxonomy`
--

CREATE TABLE IF NOT EXISTS `q61rg_finder_taxonomy` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `parent_id` int(10) unsigned NOT NULL DEFAULT '0',
  `title` varchar(255) NOT NULL,
  `state` tinyint(1) unsigned NOT NULL DEFAULT '1',
...
--
-- Dumping data for table `q61rg_finder_taxonomy`
--

INSERT INTO `q61rg_finder_taxonomy` (`id`, `parent_id`, `title`, `state`, `access`, `ordering`) VALUES
(1, 0, 'ROOT', 0, 0, 0);

-- --------------------------------------------------------

--
-- Table structure for table `q61rg_finder_taxonomy_map`
--

CREATE TABLE IF NOT EXISTS `q61rg_finder_taxonomy_map` (
  `link_id` int(10) unsigned NOT NULL,
  `node_id` int(10) unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`node_id`),
  KEY `link_id` (`link_id`),
...
--
-- Dumping data for table `q61rg_finder_taxonomy_map`
--
...
--
-- Table structure for table `q61rg_finder_terms`
--

CREATE TABLE IF NOT EXISTS `q61rg_finder_terms` (
  `term_id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `term` varchar(75) NOT NULL,
  `stem` varchar(75) NOT NULL,
  `common` tinyint(1) unsigned NOT NULL DEFAULT '0',
...
--
-- Dumping data for table `q61rg_finder_terms`
--
...
--
-- Table structure for table `q61rg_finder_terms_common`
--

CREATE TABLE IF NOT EXISTS `q61rg_finder_terms_common` (
  `term` varchar(75) NOT NULL,
  `language` varchar(3) NOT NULL,
  KEY `idx_word_lang` (`term`,`language`),
  KEY `idx_lang` (`language`)
...
--
-- Dumping data for table `q61rg_finder_terms_common`
--

INSERT INTO `q61rg_finder_terms_common` (`term`, `language`) VALUES
('a', 'en'),
('about', 'en'),
('after', 'en'),
('ago', 'en'),
...
--
-- Table structure for table `q61rg_finder_tokens`
--

CREATE TABLE IF NOT EXISTS `q61rg_finder_tokens` (
  `term` varchar(75) NOT NULL,
  `stem` varchar(75) NOT NULL,
  `common` tinyint(1) unsigned NOT NULL DEFAULT '0',
  `phrase` tinyint(1) unsigned NOT NULL DEFAULT '0',
...
--
-- Dumping data for table `q61rg_finder_tokens`
--
...
--
-- Table structure for table `q61rg_finder_tokens_aggregate`
--

CREATE TABLE IF NOT EXISTS `q61rg_finder_tokens_aggregate` (
  `term_id` int(10) unsigned NOT NULL,
  `map_suffix` char(1) NOT NULL,
  `term` varchar(75) NOT NULL,
  `stem` varchar(75) NOT NULL,
...
--
-- Dumping data for table `q61rg_finder_tokens_aggregate`
--
...
--
-- Table structure for table `q61rg_finder_types`
--

CREATE TABLE IF NOT EXISTS `q61rg_finder_types` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `title` varchar(100) NOT NULL,
  `mime` varchar(100) NOT NULL,
  PRIMARY KEY (`id`),
...
--
-- Dumping data for table `q61rg_finder_types`
--
...
--
-- Table structure for table `q61rg_languages`
--

CREATE TABLE IF NOT EXISTS `q61rg_languages` (
  `lang_id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `lang_code` char(7) NOT NULL,
  `title` varchar(50) NOT NULL,
  `title_native` varchar(50) NOT NULL,
...
--
-- Dumping data for table `q61rg_languages`
--

INSERT INTO `q61rg_languages` (`lang_id`, `lang_code`, `title`, `title_native`, `sef`, `image`, `description`, `metakey`, `metadesc`, `sitename`, `published`, `access`, `ordering`) VALUES
(1, 'en-GB', 'English (UK)', 'English (UK)', 'en', 'en', '', '', '', '', 1, 0, 2),
(2, 'ru-RU', 'Russian (RU)', 'Русский (РФ)', 'ru', 'ru', '', '', '', '', 1, 0, 1);
...
--
-- Table structure for table `q61rg_menu`
--

CREATE TABLE IF NOT EXISTS `q61rg_menu` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `menutype` varchar(24) NOT NULL COMMENT 'The type of menu this item belongs to. FK to #__menu_types.menutype',
  `title` varchar(255) NOT NULL COMMENT 'The display title of the menu item.',
  `alias` varchar(255) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL COMMENT 'The SEF alias of the menu item.',
...
--
-- Dumping data for table `q61rg_menu`
--

INSERT INTO `q61rg_menu` (`id`, `menutype`, `title`, `alias`, `note`, `path`, `link`, `type`, `published`, `parent_id`, `level`, `component_id`, `ordering`, `checked_out`, `checked_out_time`, `browserNav`, `access`, `img`, `template_style_id`, `params`, `lft`, `rgt`, `home`, `language`, `client_id`) VALUES
(1, '', 'Menu_Item_Root', 'root', '', '', '', '', 1, 0, 0, 0, 0, 0, '0000-00-00 00:00:00', 0, 0, '', 0, '', 0, 43, 0, '*', 0),
(2, 'menu', 'com_banners', 'Banners', '', 'Banners', 'index.php?option=com_banners', 'component', 0, 1, 1, 4, 0, 0, '0000-00-00 00:00:00', 0, 0, 'class:banners', 0, '', 1, 10, 0, '*', 1),
(3, 'menu', 'com_banners', 'Banners', '', 'Banners/Banners', 'index.php?option=com_banners', 'component', 0, 2, 2, 4, 0, 0, '0000-00-00 00:00:00', 0, 0, 'class:banners', 0, '', 2, 3, 0, '*', 1),
(4, 'menu', 'com_banners_categories', 'Categories', '', 'Banners/Categories', 'index.php?option=com_categories&extension=com_banners', 'component', 0, 2, 2, 6, 0, 0, '0000-00-00 00:00:00', 0, 0, 'class:banners-cat', 0, '', 4, 5, 0, '*', 1),
...
--
-- Table structure for table `q61rg_menu_types`
--

CREATE TABLE IF NOT EXISTS `q61rg_menu_types` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `menutype` varchar(24) NOT NULL,
  `title` varchar(48) NOT NULL,
  `description` varchar(255) NOT NULL DEFAULT '',
...
--
-- Dumping data for table `q61rg_menu_types`
--

INSERT INTO `q61rg_menu_types` (`id`, `menutype`, `title`, `description`) VALUES
(1, 'mainmenu', 'Главное меню', 'The main menu for the site');

-- --------------------------------------------------------

--
-- Table structure for table `q61rg_messages`
--

CREATE TABLE IF NOT EXISTS `q61rg_messages` (
  `message_id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `user_id_from` int(10) unsigned NOT NULL DEFAULT '0',
  `user_id_to` int(10) unsigned NOT NULL DEFAULT '0',
  `folder_id` tinyint(3) unsigned NOT NULL DEFAULT '0',
...
--
-- Dumping data for table `q61rg_messages`
--
...
--
-- Table structure for table `q61rg_messages_cfg`
--

CREATE TABLE IF NOT EXISTS `q61rg_messages_cfg` (
  `user_id` int(10) unsigned NOT NULL DEFAULT '0',
  `cfg_name` varchar(100) NOT NULL DEFAULT '',
  `cfg_value` varchar(255) NOT NULL DEFAULT '',
  UNIQUE KEY `idx_user_var_name` (`user_id`,`cfg_name`)
...
--
-- Dumping data for table `q61rg_messages_cfg`
--
...
--
-- Table structure for table `q61rg_modules`
--

CREATE TABLE IF NOT EXISTS `q61rg_modules` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `title` varchar(100) NOT NULL DEFAULT '',
  `note` varchar(255) NOT NULL DEFAULT '',
  `content` text NOT NULL,
...
INSERT INTO `q61rg_modules` (`id`, `title`, `note`, `content`, `ordering`, `position`, `checked_out`, `checked_out_time`, `publish_up`, `publish_down`, `published`, `module`, `access`, `showtitle`, `params`, `client_id`, `language`) VALUES
(1, 'Главное меню', '', '', 1, 'position-7', 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 1, 'mod_menu', 1, 1, '{"menutype":"mainmenu","startLevel":"0","endLevel":"0","showAllChildren":"0","tag_id":"","class_sfx":"","window_open":"","layout":"","moduleclass_sfx":"_menu","cache":"1","cache_time":"900","cachemode":"itemid"}', 0, '*'),
(2, 'Вход', '', '', 1, 'login', 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 1, 'mod_login', 1, 1, '', 1, '*'),
(3, 'Популярные материалы', '', '', 3, 'cpanel', 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 1, 'mod_popular', 3, 1, '{"count":"5","catid":"","user_id":"0","layout":"_:default","moduleclass_sfx":"","cache":"0","automatic_title":"1"}', 1, '*'),
(4, 'Новые материалы', '', '', 4, 'cpanel', 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 1, 'mod_latest', 3, 1, '{"count":"5","ordering":"c_dsc","catid":"","user_id":"0","layout":"_:default","moduleclass_sfx":"","cache":"0","automatic_title":"1"}', 1, '*'),
...
--
-- Table structure for table `q61rg_modules_menu`
--

CREATE TABLE IF NOT EXISTS `q61rg_modules_menu` (
  `moduleid` int(11) NOT NULL DEFAULT '0',
  `menuid` int(11) NOT NULL DEFAULT '0',
  PRIMARY KEY (`moduleid`,`menuid`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
--
-- Dumping data for table `q61rg_modules_menu`
--

INSERT INTO `q61rg_modules_menu` (`moduleid`, `menuid`) VALUES
(1, 0),
(2, 0),
(3, 0),
(4, 0),
...
--
-- Table structure for table `q61rg_newsfeeds`
--

CREATE TABLE IF NOT EXISTS `q61rg_newsfeeds` (
  `catid` int(11) NOT NULL DEFAULT '0',
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `name` varchar(100) NOT NULL DEFAULT '',
  `alias` varchar(255) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL DEFAULT '',
...
--
-- Dumping data for table `q61rg_newsfeeds`
--
...
--
-- Table structure for table `q61rg_overrider`
--

CREATE TABLE IF NOT EXISTS `q61rg_overrider` (
  `id` int(10) NOT NULL AUTO_INCREMENT COMMENT 'Primary Key',
  `constant` varchar(255) NOT NULL,
  `string` text NOT NULL,
  `file` varchar(255) NOT NULL,
...
--
-- Dumping data for table `q61rg_overrider`
--
...
--
-- Table structure for table `q61rg_redirect_links`
--

CREATE TABLE IF NOT EXISTS `q61rg_redirect_links` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `old_url` varchar(255) NOT NULL,
  `new_url` varchar(255) NOT NULL,
  `referer` varchar(150) NOT NULL,
...
--
-- Dumping data for table `q61rg_redirect_links`
--
...
--
-- Table structure for table `q61rg_schemas`
--

CREATE TABLE IF NOT EXISTS `q61rg_schemas` (
  `extension_id` int(11) NOT NULL,
  `version_id` varchar(20) NOT NULL,
  PRIMARY KEY (`extension_id`,`version_id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
--
-- Dumping data for table `q61rg_schemas`
--

INSERT INTO `q61rg_schemas` (`extension_id`, `version_id`) VALUES
(700, '2.5.6');

-- --------------------------------------------------------

--
-- Table structure for table `q61rg_session`
--

CREATE TABLE IF NOT EXISTS `q61rg_session` (
  `session_id` varchar(200) NOT NULL DEFAULT '',
  `client_id` tinyint(3) unsigned NOT NULL DEFAULT '0',
  `guest` tinyint(4) unsigned DEFAULT '1',
  `time` varchar(14) DEFAULT '',
...
--
-- Dumping data for table `q61rg_session`
--

INSERT INTO `q61rg_session` (`session_id`, `client_id`, `guest`, `time`, `data`, `userid`, `username`, `usertype`) VALUES
('2npp4qnhtkpvn0ig6osohki8j2', 0, 1, '1354716579', '__default|a:8:{s:15:"session.counter";i:2;s:19:"session.timer.start";i:1354716492;s:18:"session.timer.last";i:1354716492;s:17:"session.timer.now";i:1354716579;s:22:"session.client.browser";s:101:"Mozilla/5.0 (Windows NT 6.1) AppleWebKit/537.11 (KHTML, like Gecko) Chrome/23.0.1271.95 Safari/537.11";s:8:"registry";O:9:"JRegistry":1:{s:7:"\0*\0data";O:8:"stdClass":0:{}}s:4:"user";O:5:"JUser":25:{s:9:"\0*\0isRoot";b:0;s:2:"id";i:0;s:4:"name";N;s:8:"username";N;s:5:"email";N;s:8:"password";N;s:14:"password_clear";s:0:"";s:8:"usertype";N;s:5:"block";N;s:9:"sendEmail";i:0;s:12:"registerDate";N;s:13:"lastvisitDate";N;s:10:"activation";N;s:6:"params";N;s:6:"groups";a:0:{}s:5:"guest";i:1;s:13:"lastResetTime";N;s:10:"resetCount";N;s:10:"\0*\0_params";O:9:"JRegistry":1:{s:7:"\0*\0data";O:8:"stdClass":0:{}}s:14:"\0*\0_authGroups";a:1:{i:0;i:1;}s:14:"\0*\0_authLevels";a:2:{i:0;i:1;i:1;i:1;}s:15:"\0*\0_authActions";N;s:12:"\0*\0_errorMsg";N;s:10:"\0*\0_errors";a:0:{}s:3:"aid";i:0;}s:13:"session.token";s:32:"a25a39caef3de18a4341c1c9ef8f153a";}', 0, '', ''),
('jd724r19lqibd2r9dfbdks7p55', 1, 0, '1354716576', '__default|a:8:{s:15:"session.counter";i:14;s:19:"session.timer.start";i:1354716501;s:18:"session.timer.last";i:1354716576;s:17:"session.timer.now";i:1354716576;s:22:"session.client.browser";s:101:"Mozilla/5.0 (Windows NT 6.1) AppleWebKit/537.11 (KHTML, like Gecko) Chrome/23.0.1271.95 Safari/537.11";s:8:"registry";O:9:"JRegistry":1:{s:7:"\0*\0data";O:8:"stdClass":3:{s:11:"application";O:8:"stdClass":1:{s:4:"lang";s:0:"";}s:13:"com_installer";O:8:"stdClass":2:{s:7:"message";s:0:"";s:17:"extension_message";s:0:"";}s:13:"com_templates";O:8:"stdClass":1:{s:6:"styles";O:8:"stdClass":1:{s:10:"limitstart";i:0;}}}}s:4:"user";O:5:"JUser":25:{s:9:"\0*\0isRoot";b:1;s:2:"id";s:3:"681";s:4:"name";s:10:"Super User";s:8:"username";s:5:"admin";s:5:"email";s:25:"antiinformation@gmail.com";s:8:"password";s:65:"8c3314f82f98688adafdd49f8fb345ca:GI4vBlBOYnuWIajFMOCr1tC6B8fR5Tqf";s:14:"password_clear";s:0:"";s:8:"usertype";s:10:"deprecated";s:5:"block";s:1:"0";s:9:"sendEmail";s:1:"1";s:12:"registerDate";s:19:"2012-12-05 14:08:08";s:13:"lastvisitDate";s:19:"0000-00-00 00:00:00";s:10:"activation";s:1:"0";s:6:"params";s:0:"";s:6:"groups";a:1:{i:8;s:1:"8";}s:5:"guest";i:0;s:13:"lastResetTime";s:19:"0000-00-00 00:00:00";s:10:"resetCount";s:1:"0";s:10:"\0*\0_params";O:9:"JRegistry":1:{s:7:"\0*\0data";O:8:"stdClass":0:{}}s:14:"\0*\0_authGroups";a:2:{i:0;i:1;i:1;i:8;}s:14:"\0*\0_authLevels";a:4:{i:0;i:1;i:1;i:1;i:2;i:2;i:3;i:3;}s:15:"\0*\0_authActions";N;s:12:"\0*\0_errorMsg";N;s:10:"\0*\0_errors";a:0:{}s:3:"aid";i:0;}s:13:"session.token";s:32:"3823cb482a46452a5eaee166d7e4b116";}', 681, 'admin', '');

-- --------------------------------------------------------

--
-- Table structure for table `q61rg_template_styles`
--

CREATE TABLE IF NOT EXISTS `q61rg_template_styles` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `template` varchar(50) NOT NULL DEFAULT '',
  `client_id` tinyint(1) unsigned NOT NULL DEFAULT '0',
  `home` char(7) NOT NULL DEFAULT '0',
...
--
-- Dumping data for table `q61rg_template_styles`
--

INSERT INTO `q61rg_template_styles` (`id`, `template`, `client_id`, `home`, `title`, `params`) VALUES
(2, 'bluestork', 1, '1', 'Bluestork - По умолчанию', '{"useRoundedCorners":"1","showSiteName":"0"}'),
(3, 'atomic', 0, '0', 'Atomic - По умолчанию', '{}'),
(4, 'beez_20', 0, '0', 'Beez2 - По умолчанию', '{"wrapperSmall":"53","wrapperLarge":"72","logo":"images\\/joomla_black.gif","sitetitle":"Joomla!","sitedescription":"Open Source Content Management","navposition":"left","templatecolor":"personal","html5":"0"}'),
(5, 'hathor', 1, '0', 'Hathor - По умолчанию', '{"showSiteName":"0","colourChoice":"","boldText":"0"}'),
...
--
-- Table structure for table `q61rg_updates`
--

CREATE TABLE IF NOT EXISTS `q61rg_updates` (
  `update_id` int(11) NOT NULL AUTO_INCREMENT,
  `update_site_id` int(11) DEFAULT '0',
  `extension_id` int(11) DEFAULT '0',
  `categoryid` int(11) DEFAULT '0',
...
--
-- Dumping data for table `q61rg_updates`
--
...
--
-- Table structure for table `q61rg_update_categories`
--

CREATE TABLE IF NOT EXISTS `q61rg_update_categories` (
  `categoryid` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(20) DEFAULT '',
  `description` text NOT NULL,
  `parent` int(11) DEFAULT '0',
...
--
-- Dumping data for table `q61rg_update_categories`
--
...
--
-- Table structure for table `q61rg_update_sites`
--

CREATE TABLE IF NOT EXISTS `q61rg_update_sites` (
  `update_site_id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(100) DEFAULT '',
  `type` varchar(20) DEFAULT '',
  `location` text NOT NULL,
...
--
-- Dumping data for table `q61rg_update_sites`
--

INSERT INTO `q61rg_update_sites` (`update_site_id`, `name`, `type`, `location`, `enabled`, `last_check_timestamp`) VALUES
(1, 'Joomla Core', 'collection', 'http://update.joomla.org/core/list.xml', 0, 1354716507),
(2, 'Joomla Extension Directory', 'collection', 'http://update.joomla.org/jed/list.xml', 0, 1354716507);

-- --------------------------------------------------------

--
-- Table structure for table `q61rg_update_sites_extensions`
--

CREATE TABLE IF NOT EXISTS `q61rg_update_sites_extensions` (
  `update_site_id` int(11) NOT NULL DEFAULT '0',
  `extension_id` int(11) NOT NULL DEFAULT '0',
  PRIMARY KEY (`update_site_id`,`extension_id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='Links extensions to update sites';
...
--
-- Dumping data for table `q61rg_update_sites_extensions`
--

INSERT INTO `q61rg_update_sites_extensions` (`update_site_id`, `extension_id`) VALUES
(1, 700),
(2, 700);
...
--
-- Table structure for table `q61rg_usergroups`
--

CREATE TABLE IF NOT EXISTS `q61rg_usergroups` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Primary Key',
  `parent_id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT 'Adjacency List Reference Id',
  `lft` int(11) NOT NULL DEFAULT '0' COMMENT 'Nested set lft.',
  `rgt` int(11) NOT NULL DEFAULT '0' COMMENT 'Nested set rgt.',
...
--
-- Dumping data for table `q61rg_usergroups`
--

INSERT INTO `q61rg_usergroups` (`id`, `parent_id`, `lft`, `rgt`, `title`) VALUES
(1, 0, 1, 20, 'Все'),
(2, 1, 6, 17, 'Зарегистрированные'),
(3, 2, 7, 14, 'Авторы'),
(4, 3, 8, 11, 'Редакторы'),
...
--
-- Table structure for table `q61rg_users`
--

CREATE TABLE IF NOT EXISTS `q61rg_users` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) NOT NULL DEFAULT '',
  `username` varchar(150) NOT NULL DEFAULT '',
  `email` varchar(100) NOT NULL DEFAULT '',
...
--
-- Dumping data for table `q61rg_users`
--
...
(681, 'Super User', 'admin', 'antiinformation@gmail.com', '8c3314f82f98688adafdd49f8fb345ca:GI4vBlBOYnuWIajFMOCr1tC6B8fR5Tqf', 'deprecated', 0, 1, '2012-12-05 14:08:08', '2012-12-05 14:08:24', '0', '', '0000-00-00 00:00:00', 0);

-- --------------------------------------------------------

--
-- Table structure for table `q61rg_user_notes`
--

CREATE TABLE IF NOT EXISTS `q61rg_user_notes` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `user_id` int(10) unsigned NOT NULL DEFAULT '0',
  `catid` int(10) unsigned NOT NULL DEFAULT '0',
  `subject` varchar(100) NOT NULL DEFAULT '',
...
--
-- Dumping data for table `q61rg_user_notes`
--
...
--
-- Table structure for table `q61rg_user_profiles`
--

CREATE TABLE IF NOT EXISTS `q61rg_user_profiles` (
  `user_id` int(11) NOT NULL,
  `profile_key` varchar(100) NOT NULL,
  `profile_value` varchar(255) NOT NULL,
  `ordering` int(11) NOT NULL DEFAULT '0',
...
--
-- Dumping data for table `q61rg_user_profiles`
--
...
--
-- Table structure for table `q61rg_user_usergroup_map`
--

CREATE TABLE IF NOT EXISTS `q61rg_user_usergroup_map` (
  `user_id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT 'Foreign Key to #__users.id',
  `group_id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT 'Foreign Key to #__usergroups.id',
  PRIMARY KEY (`user_id`,`group_id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
--
-- Dumping data for table `q61rg_user_usergroup_map`
--

INSERT INTO `q61rg_user_usergroup_map` (`user_id`, `group_id`) VALUES
(681, 8);

-- --------------------------------------------------------

--
-- Table structure for table `q61rg_viewlevels`
--

CREATE TABLE IF NOT EXISTS `q61rg_viewlevels` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Primary Key',
  `title` varchar(100) NOT NULL DEFAULT '',
  `ordering` int(11) NOT NULL DEFAULT '0',
  `rules` varchar(5120) NOT NULL COMMENT 'JSON encoded access control.',
...
--
-- Dumping data for table `q61rg_viewlevels`
--

INSERT INTO `q61rg_viewlevels` (`id`, `title`, `ordering`, `rules`) VALUES
(1, 'Для всех', 0, '[1]'),
(2, 'Для зарегистрированных', 1, '[6,2,8]'),
(3, 'Для администрации', 2, '[6,3,8]');
...
--
-- Table structure for table `q61rg_weblinks`
--

CREATE TABLE IF NOT EXISTS `q61rg_weblinks` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `catid` int(11) NOT NULL DEFAULT '0',
  `sid` int(11) NOT NULL DEFAULT '0',
  `title` varchar(250) NOT NULL DEFAULT '',
...
--
-- Dumping data for table `q61rg_weblinks`
--
